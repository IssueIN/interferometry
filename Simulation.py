...
# Add spectral elements to the interferogram
# wl_1 = 550e-9 # central wavelength of the Gaussian
# sigma_1 = 1e-9 # standard deviation of the Gaussian
# amp_1=1.0
# y=add_gaussian(x,y,wl_1,amp_1,sigma_1,nmodes)

# wl_2 = 560e-9 # central wavelength of the Gaussian
# sigma_2 = 0.1e-9 # standard deviation of the Gaussian
# amp_2=1.0
# y=add_gaussian(x,y,wl_2,amp_2,sigma_2,nmodes)

# add a square wave
start_wavelength = 590e-9 # metres
width = 10e-9 # metres
amp = 1.0 # amplitude
